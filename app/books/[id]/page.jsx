...
function BookDetailsContent() {
  ...
  const { book, canReview, isLibrarianOwner, hasRequestedDelivery } = data;
          ...
          <div className="pt-2">
            {isLibrarianOwner ? (
              ...
              <button
                ...
                // Button disables completely if already requested, out of stock, or processing!
                disabled={
                  !isAvailable ||
                ...
                className={`w-full py-3 px-4 rounded-xl font-medium tracking-wide shadow-sm flex items-center justify-center gap-2.5 transition-all duration-200 ${isAvailable && !isSuccess && !isCheckedOut && !hasRequestedDelivery ? "bg-[#635BFF] hover:bg-[#5249E0] text-white active:scale-[0.99]" : "bg-gray-200 text-gray-400 cursor-not-allowed shadow-none"}`}
              >
                <svg
        ...
        {canReview ? (
          <div className="bg-gray-50 rounded-xl border border-gray-100 p-5 space-y-4 max-w-xl">
            ...
            <textarea
              ...
              placeholder="Leave your review parameters..."
              className="w-full bg-white border border-gray-200 rounded-lg p-3 text-sm focus:outline-none focus:border-gray-400 placeholder:text-gray-300"
            />
            <button
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-xl p-4 text-xs text-gray-400 font-medium max-w-xl">
            🔒 Reviews are exclusively unlocked for verified readers who have
            purchased a physical delivery match trace.
          </div>
        )}
