...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-neutral-900/95 border-t border-neutral-900 text-slate-300  mt-auto py-12 md:py-16">
        ...
        <div className="flex flex-col items-center text-center md:items-end md:text-right space-y-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              rel="noreferrer"
              aria-label="Facebook"
              className="p-3 bg-stone-950 hover:bg-stone-700 text-slate-300 hover:text-white rounded-xl transition-colors"
            >
